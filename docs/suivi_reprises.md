...
| P2 | retour technique 1,00 m « à adapter selon hauteur d'eau / NDC » | À FAIRE (MTEXT #1FD81/#1FE5F zone folio 2) |
| P4/P20 | solin 3x3 époxy vs polymérique | **QUESTION** : quelle cible ? (P4=époxy, P20=polymérique, mail ne tranche pas) |
| P8 | renvoi explicite folios 30-33 | À FAIRE (texte « voir détail » à localiser) |
...
| P25 | NOTA joints PM radier → renvoi folios 40-43 | À FAIRE |
| P27 | seuil hauteur d'eau > 10 m | **BLOQUÉ** (point 5) |
| P27 | tôle galva/inox harmonisation | À FAIRE (localiser la tôle du folio 27) |
...
| P41 | bande pontage : résine époxy + préparation | À FAIRE |
| P44 | légende exigences berlinoise (≤5 cm, chanfrein 45°, 90 kPa) | À FAIRE |
| P45 | raccord DEG/FPM | **BLOQUÉ** (point 4) |
| P45 | FPM bicouche anti-racine « uniquement si végétalisation » | À FAIRE (#1746C) |
...
| P51 | resurfaçage → 1504-3 R3 mini + tolérances | À FAIRE (localiser « Resurfaçage » folio 51) |
| P52-54 | resurfaçage →1504-3 | À FAIRE |
...
| P55-60 | resurfaçage R3 →1504-3 | À FAIRE (vérifier occurrences restantes) |
| P56-60 | feuillard matériau + entraxe | **FAIT** (lot 1, 9 occ.) |
| P61 | « SEL-A sous référentiel CETU » | À FAIRE |
...
| P65 | « centré 70 mm mini » → débord mini de part et d'autre | À FAIRE |
