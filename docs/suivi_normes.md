...
| N7 | Lecture **C10F1 structures intégrées (publication)** → extraits (pertinence folios gares/structures : 12-25, 61-64) | **EN COURS** (2026-07-14 : §7 arrêt sous radier LU = base folios 30-33 ; ⚠️ seuil 8 m au §5 → info point BLOQUÉ 5 ; divergences 5/6 cm trait de scie et R3/R4 à signaler ; reste §5/6/8/9/10/11 — `extraits_C10F1.md`) |
